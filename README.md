...
**v0.11.0** — 3500+ testes, 78% cobertura, 25/25 fontes com golden tests (21 com dados reais), retry centralizado em 25/25 clients.
...
- **3500+ testes, 78% cobertura** — benchmarks de escalabilidade (memory, volume, cache, async)
