...
> **Notice:** agrobr is licensed under MIT, but the **data** accessed belongs
> to its respective sources and is subject to each one's terms.
> It is the user's responsibility to verify that their use case complies.
